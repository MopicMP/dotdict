...
[![PyPI version](https://badge.fury.io/py/dotdict.svg)](https://pypi.org/project/dotdict/)
...
# Basic usage
result = dotdict("your input here")
print(result)
```
...
result = dotdict("Hello World")

# Example 2: Batch processing
from dotdict import batch
